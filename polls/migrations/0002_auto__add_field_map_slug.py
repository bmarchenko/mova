...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Map.slug'
        db.add_column(u'polls_map', 'slug',
                      self.gf('autoslug.fields.AutoSlugField')(default=1, unique_with=(), max_length=50, populate_from=None),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Map.slug'
        db.delete_column(u'polls_map', 'slug')
