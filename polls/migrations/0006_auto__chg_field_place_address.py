...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column(u'polls_place', 'address', self.gf('django.db.models.fields.CharField')(max_length=2000))

    def backwards(self, orm):

        # Changing field 'Place.address'
        db.alter_column(u'polls_place', 'address', self.gf('django.db.models.fields.CharField')(max_length=500))
